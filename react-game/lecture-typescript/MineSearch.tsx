import React, { useEffect, useReducer, Dispatch, createContext, useMemo } from 'react';
import {
    CLICK_MINE, FLAG_CELL, INCREMENT_TIMER, NORMALIZE_CELL, OPEN_CELL, QUESTION_CELL, START_GAME,
    ReducerActions
} from './action'
